        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-slate-700 leading-relaxed">
              ...
              Documenti decentralizzati, immutabili e permanenti archiviati
              sulla rete IPFS.
              <br />
              <br />
              ...
              Facile aggiornamento e gestione, visibili a tutti gli investitori
              della pool.
            </p>
          </div>
        </div>
